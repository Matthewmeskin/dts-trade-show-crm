...
export default async function AppLayout({
  ...
  // Being signed in is not access. This login is shared with the payables,
  // vetting and Exemplis portals, so most accounts that can authenticate here
  // were never granted the CRM; a row in tradeshow.profiles is the grant.
  // This used to read `profile?.role ?? "standard"`, which turned every one of
  // those accounts into a standard CRM user the moment they opened the URL.
