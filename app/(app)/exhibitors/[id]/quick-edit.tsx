...
/**
 * Edit an exhibitor in a popup instead of navigating to the edit page. Reuses
 * the full ExhibitorForm; saving redirects back here (which closes the modal).
 */
        ...
        >
          <div className="w-full max-w-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="mb-3 flex items-center justify-between text-white">
              <h2 className="font-heading text-lg font-semibold">Edit exhibitor</h2>
              <button
                type="button"
                onClick={() => setOpen(false)}
                aria-label="Close"
